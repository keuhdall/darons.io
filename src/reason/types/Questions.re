...
let all = [
  ...
  {content: {j|As-tu déjà parlé sérieusement de PEL/PEA et autres taux d’intérêt bancaires avec tes amis ?|j},          coef: 1.0},
  {content: {j|Est-ce que tu comprends tes papiers de mutuelle/assurance ?|j},                                          coef: 1.0},
  {content: {j|Ton livret jeune a-t-il été clôturé à la banque ?|j},                                                    coef: 1.0},
  {content: {j|Est-ce que tu relis tous les mois ton loyer ou ta fiche de paie pour voir si ça a bougé ?|j},            coef: 1.0},
  {content: {j|Est-ce que tes rendez-vous avec ton conseiller bancaire sont à ton initiative plus qu'à la sienne ?|j},  coef: 1.0},
  ...
  {content: {j|Les grasses matinées sont-elles devenues difficiles ?|j},                    coef: 1.0},
  ...
  {content: {j|Est-ce que ta vision a baissé au point de porter des lunettes ?|j},          coef: 1.0},
  ...
  {content: {j|As-tu accepté qu’on t’appelle Mr/Mme sans que ça te fasse quoi que ce soit ?|j},                               coef: 1.0},
  {content: {j|Les plus jeunes que toi utilisent-ils des mots qui te sont inconnus ?|j},                                      coef: 1.0},
  {content: {j|As-tu des amis de ton âge qui commencent à parler des enfants/avoir des enfants ?|j},                          coef: 1.0},
  {content: {j|As-tu été invité au mariage de quelqu'un de ton âge ?|j},                                                      coef: 1.0},
  ...
  {content: {j|Est-ce que tu relis ton ticket de course, pour vérifier au cas où ?|j},        coef: 1.0},
  ...
  {content: {j|Est-ce que tu vérifies ta boîte aux lettres tous les jours ?|j},                                       coef: 1.0},
  {content: {j|Les réductions étudiantes, c'est fini pour toi ?|j},                                                   coef: 1.0},
  ...
  {content: {j|Est-ce que tu comates devant les émissions TV que tu trouvais débiles ?|j},                            coef: 1.0},
  {content: {j|As-tu déjà changé un pneu, un rétro, ou quoi que ce soit d'autre dans ta voiture ?|j},                 coef: 1.0},
  {content: {j|As-tu déjà fait des travaux dans ton appartement ?|j},                                                 coef: 1.0},
  ...
  {content: {j|Est-ce tu préfères le SUV à la voiture de sport ?|j},                                                  coef: 1.0},
  {content: {j|Est-ce que tu râles devant ta TV quand tu regardes le journal de 20h ?|j},                             coef: 1.0},
  ...
  {content: {j|Est-ce que tu connais par coeur des tubes des années 80 ? (Indochine, Sardou, ...)|j},                 coef: 1.0},
  ...
  {content: {j|Est-ce que tu te mets de profil devant le miroir pour constater les dégâts ?|j},                       coef: 1.0}
];
